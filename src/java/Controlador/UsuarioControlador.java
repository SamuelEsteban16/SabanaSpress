        ...
        switch (opcion) {
            ...
            case 3: //Iniciar Sesión
                ...
                if (usuDAO.iniciarSesion(usuLogin, usuPassword)) {
                    ...
                    ArrayList<RolVO> listaRoles = rolDAO.roles(usuLogin);
                    ...
                    if (rolVO.getNombreRol().equals("Cliente")){
                        request.getRequestDispatcher("Cliente/DashboardC.jsp").forward(request, response);
                       
                       
                        
                    }else if (rolVO.getNombreRol().equals("Farmaceutico")){
                        request.getRequestDispatcher("Farmaceutico/DashboardF.jsp").forward(request, response);
                    }else if (rolVO.getNombreRol().equals("Gerente")){
