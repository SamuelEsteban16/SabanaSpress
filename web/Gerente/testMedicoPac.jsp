<%-- 
    ...
    Created on : 29/07/2021, 07:22:28 PM
    Author     : Personal
--%>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="ConsultaProductos.jsp"class=""><span class="las la-receipt"></span>
                        <span>Inventory</span>
                    </a>
                </li>
                
                <li>
                    <a href="Test.html"class="active"><span class="las la-clipboard-list"></span>
