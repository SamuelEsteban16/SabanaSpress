<%-- 
    ...
    Created on : 29/07/2021, 07:19:47 PM
    Author     : Personal
--%>
                                    ...
                                    <form class="form" role="form" autocomplete="off">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12 text-center">
                                                <a href="perfil.jsp"><input type="button" class="btn btn-secondary" value="cancelar">
                                                <a href="perfil.jsp"><input type="button" class="btn btn-primary" value="Actualizar">
                                            </div>
                                        </div>
                                    </form>
                                </div>
