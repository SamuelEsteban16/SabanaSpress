<%-- 
    ...
    Created on : 29/07/2021, 07:20:04 PM
    Author     : Personal
--%>
                                    ...
                                    <form class="form" role="form" autocomplete="off">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12 text-center">
                                                <a href="registrar_usuario.jsp"><input type="button" class="btn btn-secondary" value="cancelar">
                                                <a href="registrar_usuario.jsp"><input type="button" class="btn btn-primary" value="Actualizar">
                                            </div>
                                        </div>
                                    </form>
                                </div>
