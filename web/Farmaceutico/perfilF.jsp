<%-- 
    Document   : perfilF
    Created on : 29/07/2021, 07:15:14 PM
    Author     : Personal
--%>
                ...
                <div class="perfil-usuario-header">
                    <div class="perfil-usuario-portada">
                        <div class="perfil-usuario-avatar">
                            <img src="../assets/img/3.jpg" alt="img-avatar">
                ...
                <div class="perfil-usuario-body">
                    ...
                    <div class="perfil-usuario-footer">
                        ...
                        <ul class="lista-datos">
                            ...
                            <li></li>
                            <li><i class="icono fas fa-building"></i> Cargo: <span>Farmaceutico</span></li>
                            <li></li>
                    ...
                    <div class="col-lg-12 text-center">
                        <a href="ActualizarPerfilF.jsp"><input type="button" class="btn btn-secondary" value="Actualizar">
                            </a>
                            </div>
                        </div>
