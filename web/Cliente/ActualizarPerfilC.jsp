<%-- 
    Document   : ActualizarPerfilCliente
    Created on : 29/07/2021, 07:10:46 PM
    Author     : Personal
--%>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form" role="form" autocomplete="off">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12 text-center">
                                                <a href="perfilC.jsp"><input type="button" class="btn btn-secondary" value="cancelar">
                                                <a href="perfilC.jsp"><input type="button" class="btn btn-primary" value="Actualizar">
                                            </div>
                                        </div>
                                    </form>
                                </div>
